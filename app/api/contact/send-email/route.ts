      ...
      personalizations: [
        {
          ...
          subject: 'Thank you for contacting RheinBrücke'
        }
      ],
      content: [
        {
              ...
              <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px;">
                  ...
                  <div style="background: #fff; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #48bb78;">
                    <h3 style="margin-top: 0; color: #1a202c;">Your Inquiry Details:</h3>
                  ...
                  <p style="font-size: 16px; margin-top: 20px;">
                    Best regards,<br>
                    <strong>The RheinBrücke Team</strong>
                  </p>
                </div>
...
This is an automated notification from the RheinBrücke contact form.
          ...
          value: `
            ...
            <html>
              ...
              <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="text-align: center; margin-top: 20px; padding: 20px; color: #6b7280; font-size: 12px;">
                  <p>This is an automated notification from the RheinBrücke contact form.</p>
