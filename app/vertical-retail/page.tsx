...
const page = () => {
  ...
  <div className="main-baner-hight retail-baner ">
    ...
    <div className="">
      <video src="/new/vr777.mp4" autoPlay={true} muted={true} loop={true} playsInline={true} />
    </div>
  </div>
  ...
  <section className="mds-section pq-dark-waber pd50">
    <div className="container">
