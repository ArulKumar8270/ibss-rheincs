...
>
  ...
  aria-label="ERP and digital platform integration icon"
                        ...
                        {/* <div class="service-arrow">
                                  <Link href="#!"><Image src="/images/arrow-accent.svg" alt=""></Link>
                              </div> */}
                      </div>
                      <div className="service-item-body">
                        <h3>{t("Integrate")}</h3>
                    ...
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide">
                        <div className="service-item ">
                          <div className="service-item-header">
                            <div className="icon-box">
                              <Image src="/images/a1.svg" alt="Digital analytics icon" fill style={{objectFit: "contain"}} />
                            </div>
                          </div>
                          <div className="service-item-body">
                            <h3>{t("Analyse")}</h3>
                      ...
                      <div className="swiper-slide">
                        <div className="service-item ">
                          ...
                          <div className="service-item-header">
                            <div className="icon-box">
                              <Image src="/images/i1.svg" alt="ERP and digital platform integration icon" fill style={{objectFit: "contain"}} />
                            </div>
                            {/* <div class="service-arrow">
                                  <Link href="#!"><Image src="/images/arrow-accent.svg" alt=""></Link>
                              </div> */}
                      ...
                      <div className="swiper-slide">
                        <div className="service-item ">
                          ...
                          <div className="service-item-header">
                            <div className="icon-box">
                              <Image src="/images/t1.svg" alt="Digital analytics icon" fill style={{objectFit: "contain"}} />
                            </div>
                            {/* <div class="service-arrow">
                                  <Link href="#!"><Image src="/images/arrow-accent.svg" alt=""></Link>
                              </div> */}
  ...
  preload="none"
  id="myVideo"
  poster="/images/globe-poster.webp"
>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="row mt-5">
                    <div className="col-lg-6 col-md-6 col-6">
                      ...
                      <div className="benefits-steps-item wow fadeInUp">
                        <div className="icon-box">
                          <Image src="/images/r1.svg" alt="" fill style={{objectFit: "contain"}} />
                        </div>
                        <div className="benefits-steps-content">
                          <h3>{t("Proven Methodology (AIT) - Analyse. Integrate. Transform.")}</h3>
                          <p>{t("Achieve measurable transformation across your business.")}</p>
                  ...
                  <div className="col-lg-6 col-md-6 col-6">
                      ...
                      >
                        <div className="icon-box">
                          <Image src="/images/r2.svg" alt="" fill style={{objectFit: "contain"}} />
                        </div>
                        <div className="benefits-steps-content">
                          <h3>{t("Industry Expertise Across Verticals")}</h3>
                          <p>{t("Deep experience in manufacturing, retail, automotive and private equity.")}</p>
                    ...
                    <div className="col-lg-6 col-md-6 col-6">
                      ...
                      >
                        <div className="icon-box">
                          <Image src="/images/r3.svg" alt="" fill style={{objectFit: "contain"}} />
                        </div>
                        <div className="benefits-steps-content">
                          <h3>{t("Global Delivery. Local Execution.")}</h3>
                          <p>{t("Efficient, rapidly executed cost-effective transformation programs.")}</p>
                  ...
                  <div className="col-lg-6 col-md-6 col-6">
                      ...
                      >
                        <div className="icon-box">
                          <Image src="/images/r4.svg" alt="" fill style={{objectFit: "contain"}} />
                        </div>
                        <div className="benefits-steps-content">
                          <h3>{t("Clear ROI, Quantified Results")}</h3>
                          <p>{t("Enhanced operational performance and customer value.")}</p>
              ...
              <div className="digital-features-item agency-supports mt-5">
                <div className="logo-marquee">
                  ...
                  <div className="logo-slider ltr">
                    <div className="logos">
                      <Image src="/images/clients1/1-American-golf.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/2-cold-chain-tech.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/10-bond.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/11-sembcorp.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/12-cellcentric.png" loading="lazy" alt="logo" width={150} height={80} />
                      {/* repeat for smooth scrolling */}
                      <Image src="/images/clients1/13-ecolean.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/14-ceco.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/15-TRW.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/16-kraft.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/17-eccbc.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/18-oman-fiber.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/19-kern.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/20-flsmidth.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/21-kone.png" loading="lazy" alt="logo" width={150} height={80} />
                      <Image src="/images/clients1/22-tadco.png" loading="lazy" alt="logo" width={150} height={80} />
                    </div>
                  </div>
                  {/* Row 2 */}
                  <div className="logo-slider rtl">
                    <div className="logos">
                      <Image src="/images/clients1/23-rsp.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/24-kempi.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/25-nucor.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/26-rfa.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/27-schalke.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/28-gemaco.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/29-talents.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/30-tialoc.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/31-zamil.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/32-eva.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/33-nasco.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/34-global-industries.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/35-ghassan.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/36-glaze.png" loading="lazy" alt="logo" width={150} height={100} />
                      <Image src="/images/clients1/37-greentech.png" loading="lazy" alt="logo" width={150} height={100} />
                    </div>
                  </div>
                </div>
              </div>
