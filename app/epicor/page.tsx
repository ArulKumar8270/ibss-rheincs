                                        ...
                                        <div className="faq-accordion" id="accordion">
                                            ...
                                            <div className="accordion-item wow fadeInUp">
                                                <h2 className="accordion-header" id="heading1">
                                                    ...
                                                    >
                                                        Lorem ipsum dolor sit amet consectetur. Venenatis integer
                                                        interdum sed risus quis
                                                    </button>
                                                </h2>
                                                <div
                                                    id="collapse1"
                                                ...
                                                >
                                                    <div className="accordion-body">
                                                        <p>
                                                            ...
                                                            integer interdum sed risus quis pellentesque arcu sit.
                                                            Metus non adipiscing quis sagittis
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
