                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/implementation.svg" alt="" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/end-t-end-order-management.svg" alt="" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/system-integration.svg" alt="" />
                                            <p>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/inventory-visibility.svg" alt="" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/ship-to-store.svg" alt="" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/custom-workflow.svg" alt="" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="valueslide">
                                            <img src="/iamges/oms-support.svg" alt="" />
