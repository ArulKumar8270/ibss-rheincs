  ...
  return (
    <CommomLayout>
      <>
              ...
              <div className="col-sm-5">
                <div className="section-title">
                  <h2 className="text-anime-style-21" data-cursor="-opaque">
                    {t("AI, Machine Learning & Data Analytics Solutions")}
                  </h2>
                  <p>
                    {t(
                      "Transform enterprise data into actionable intelligence with AI-driven analytics, predictive insights, and intelligent automation.",
                    )}
                  </p>
                  <p>
                    {t(
                      "Leverage Google AI/ML, Azure Machine Learning, and advanced analytics to unlock predictive insights, operational efficiency, and business growth.",
                    )}
                  </p>
                </div>
              </div>
        ...
        <div
          className={`our-testimonial epiccompanion pd30 ${language === "German" ? "germanaiml" : ""}`}
        >
          <div className="container">
                            ...
                            <div className="flip-card-front">
                              ...
                              <div className="service-item-header ">
                                <div className="service-card">
                                  <img
                                    src="/images/ss1.svg"
                                    alt="AI and ML Data analytics for Brand Owners & Vertical Retailers icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body  oa-para-waber">
                                ...
                                <p className="oa-para">
                                  {t(
                                    "Personalised recommendations, dynamic pricing, inventory optimisation, loss prevention, and customer analytics.",
                                  )}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flip-card-front ">
                              ...
                              <div className="service-item-header">
                                <div className="service-card">
                                  <img
                                    src="/images/ss2.svg"
                                    alt="AI and ML Data analytics for 
Retail Industry icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body oa-para-waber">
                                <h3>{t("Retail Industry")}</h3>
                                <p className="oa-para">
                                  {t(
                                    "Customer segmentation, AI-powered demand forecasting, fraud detection, and real-time analytics to improve omnichannel retail performance.",
                                  )}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flip-card-front">
                              ...
                              <div className="service-item-header">
                                <div className="service-card">
                                  <img
                                    src="/images/ss3.svg"
                                    alt="AI and ML Data analytics for Supply chain and distribution icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body oa-para-waber">
                                <h3>{t("Distribution & Supply Chain")}</h3>

                                <p className="oa-para">
                                  {t(
                                    "Route optimisation, warehouse automation, predictive delivery times, supply chain optimisation, and supply chain risk analytic.",
                                  )}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flip-card-front">
                              ...
                              <div className="service-item-header">
                                <div className="service-card">
                                  <img
                                    src="/images/ss10.svg"
                                    alt="AI and ML Data analytics for process manufacturing icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body oa-para-waber">
                                <h3>{t("Discrete Manufacturing")}</h3>

                                <p className="oa-para">
                                  {t(
                                    "Predictive process control, predictive analytics, energy optimisation, waste reduction, and safety analytics to improve production efficiency.",
                                  )}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flip-card-front ">
                              ...
                              <div className="service-item-header">
                                <div className="service-card">
                                  <img
                                    src="/images/ss4.svg"
                                    alt="AI and ML Data analytics for Automotive Industry icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body oa-para-waber">
                                <h3>{t("Automotive Industry")}</h3>
                                <p className="oa-para">
                                  {t(
                                    "Smart manufacturing, connected vehicle analytics, predictive maintenance, safety monitoring, and vehicle performance analytics.",
                                  )}
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="flip-card-inner">
                            ...
                            <div className="flip-card-front ">
                              ...
                              <div className="service-item-body oa-para-waber">
                                ...
                                <p className="oa-para">
                                  {t(
                                    "Project cost forecasting, risk modelling, resource optimisation, and contract intelligence.",
                                  )}
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="service-item flip-card">
                          <div className="flip-card-inner">
                            ...
                            <div className="flip-card-front ">
                              ...
                              <div className="service-item-body oa-para-waber">
                                <h3>{t("Process Manufacturing")}</h3>

                                <p className="oa-para">
                                  {t(
                                    "Predictive process control, energy optimisation, waste reduction, and safety analytics.",
                                  )}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flip-card-front ">
                              ...
                              <div className="service-item-header">
                                <div className="service-card">
                                  <img
                                    src="/images/ss6.svg"
                                    alt="AI and ML Data analytics for Private Equity & Funding-backed Ventures icon"
                                  />
                                </div>
                              </div>
                              <div className="service-item-body oa-para-waber">
                                ...
                                <p className="oa-para">
                                  {t(
                                    "Portfolio performance analytics, risk scoring, market trend prediction, value creation tracking, and data-driven decision support.",
                                  )}
                                </p>
                              </div>
                            </div>
                  ...
                  <div className="section-title">
                    <div className="hero-video-content wow fadeInUp mt-4">
                      <h2
                        ...
                        data-cursor="-opaque"
                      >
                        {t("Why Choose us For AI and ML Data Analytics?")}
                      </h2>
                    </div>
                  </div>
                </div>
            ...
            <div className="row justify-content-center">
              <div className="col-sm-3 col-6">
                <div className="dynamics-advantage-waber">
                  ...
                  <p>
                    {t(
                      "Proven expertise in Google Cloud AI and Azure-based AI implementations.",
                    )}
                  </p>
                </div>
              </div>
              <div className="col-sm-3 col-6">
                <div className="dynamics-advantage-waber">
                  ...
                  <p>
                    {t(
                      "Seamless integration with ERP, CRM, data platforms, and custom applications.",
                    )}
                  </p>
                </div>
              </div>
              <div className="col-sm-3 col-6">
                <div className="dynamics-advantage-waber">
                  ...
                  <p>
                    {t(
                      "End-to-end support from design to deployment, optimisation, and ongoing innovation.",
                    )}
                  </p>
                </div>
              </div>
              <div className="col-sm-3 col-6">
                <div className="dynamics-advantage-waber">
                  ...
                  <p>{t("Relentless focus on measurable outcomes and ROI.")}</p>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="faq-accordion" id="accordion">
                      ...
                      <div className="accordion-item wow fadeInUp">
                        <h2 className="accordion-header" id="heading1">
                          ...
                          >
                            {t(
                              "How does RheinBrücke assist enterprises with AI/ML adoption?",
                            )}
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              {t(
                                "RheinBrücke designs and deploys AI/ML solutions that drive predictive maintenance, process optimization, and intelligent automation, helping enterprises reduce downtime, increase efficiency, and streamline operations with data-driven AI technology.",
                              )}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <h2 className="accordion-header" id="heading2">
                          ...
                          >
                            {t(
                              "Can AI integrate with ERP and CRM systems?",
                            )}
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              {t(
                                "Yes, RheinBrücke’s AI solutions integrate seamlessly with ERP, CRM, and analytics platforms, enhancing operational intelligence and automating workflows to provide unified, actionable insights across business functions.",
                              )}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <h2 className="accordion-header" id="heading3">
                          ...
                          >
                            {t(
                              "Which industries can benefit from AI/ML?",
                            )}
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              {t(
                                "Industries such as manufacturing, retail, logistics, and EPC leverage AI/ML to get deeper insights, reduce costs, improve accuracy, automate repetitive tasks, and enable real-time decision-making to boost competitiveness and operational agility.",
                              )}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <h2 className="accordion-header" id="heading4">
                          ...
                          >
                            {t(
                              "Does RheinBrücke provide AI strategy consulting?",
                            )}
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              {t(
                                "Yes, RheinBrücke offers AI strategy consulting that helps organizations identify high-value use cases, build proofs-of-concept, and develop scalable AI roadmaps to accelerate enterprise AI adoption and innovation.",
                              )}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              {t(
                                "Artificial Intelligence (AI) enables systems to perform tasks that typically require human intelligence. Machine Learning (ML) is a subset of AI that learns from data to improve outcomes, while data analytics focuses on extracting insights from data to support business decisions.",
                              )}
                            </p>
                          </div>
                        </div>
              ...
              <div className="firstrow">
                <div className="row">
                  <div className="col-sm-8">
                    <h2>
                      {t(
                        "Your data holds the insights to drive smarter decisions, greater efficiency, and sustainable growth.",
                      )}
                    </h2>
                    <p>{t("Talk to our AI and Machine Learning experts to explore how.")}</p>
                  </div>
