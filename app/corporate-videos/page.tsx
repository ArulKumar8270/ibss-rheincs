      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          ...
          <div className="video-gallery-image wow fadeInUp">
            <a
              href="https://youtu.be/IDrR7hiizhI"
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/MmXOpBXQdZM"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/-t5b2gIdhyo"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/B-XFRUeSlUs"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/yvtX2yqWxVg"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/C6sDlZCKIA4"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/TIIjLQps44U"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/s2jmxT8fP5c"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/Y3Kc616jPU0"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            <a
              href="https://youtu.be/G1M5A1CBpYY"
              className="popup-video"
              data-cursor-text="Play"
            >
              <figure>
